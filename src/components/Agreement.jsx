...
export default function Agreement({ pkg, onAgree, agreed }) {
  ...
  const pdfFilename = `agreement-${(pkg.name || "document")
    .toLowerCase()
    .replace(/\s+/g, "-")}`;

  return (
    <PrintToPDF filename={pdfFilename} buttonLabel="Download Agreement PDF">
        ...
        <CardContent className="p-8 md:p-12 space-y-12">
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed font-medium">
              ...
              service cost and service scope outlined by{" "}
              ...
              <div className="p-8 bg-primary/[0.05] rounded-3xl border border-primary/10 space-y-6 shadow-inner">
                ...
                <div className="pt-6 border-t border-primary/10 space-y-4">
                  <p className="text-[11px] text-muted-foreground/70 leading-relaxed italic font-medium">
                    "A refundable reservation fee is required to secure the
          ...
          <div className="flex items-start gap-5 w-full bg-card p-6 rounded-2xl border border-border/10 shadow-lg">
            ...
            >
              ...
              <p className="text-[11px] text-muted-foreground font-medium leading-relaxed max-w-xl">
                By checking this box, I electronically authenticate and
                authorize this commitment. I am bound by the professional terms,
                conditions, and financial obligations outlined in this service
                proposal.
              </p>
            </div>
          </div>
